...
//! All tests use transactional rollback for isolation: test data is automatically cleaned up
//! after each test completes, ensuring no dangling test data persists.
...
use sea_orm::{
    ActiveModelTrait, ColumnTrait, Database, EntityTrait, QueryFilter, Set, TransactionTrait,
};
use uuid::Uuid;
...
/// Execute test logic within a database transaction that automatically rolls back
///
/// This ensures complete test isolation: any data created during the test is discarded
/// after the test completes (success or failure), preventing test pollution.
/// The transaction rollback is automatic—no manual cleanup needed.
async fn with_transaction<F, Fut, T>(db: &sea_orm::DbConn, test_fn: F) -> T
where
    ...
    Fut: std::future::Future<Output = T>,
{
    ...
    // Implicit rollback on drop ensures all changes are discarded
    result
}
...
async fn test_accept_incident_with_confidence() {
    ...
    with_transaction(&db, |txn| {
        async move {
            ...
            let fixture_id = Uuid::parse_str("11111111-1111-1111-1111-111111111111")
                .expect("Invalid fixture UUID");
...
async fn test_reject_incident() {
    ...
    with_transaction(&db, |txn| {
        async move {
            // Pick a fixture incident
            let fixture_id = Uuid::parse_str("22222222-2222-2222-2222-222222222222")
                .expect("Invalid fixture UUID");
...
async fn test_edit_incident() {
    ...
    with_transaction(&db, |txn| {
        async move {
            // Pick a fixture incident
            let fixture_id = Uuid::parse_str("33333333-3333-3333-3333-333333333333")
                .expect("Invalid fixture UUID");
...
async fn test_confidence_score_bounds() {
    ...
    with_transaction(&db, |txn| {
        async move {
            let fixture_id = Uuid::parse_str("44444444-4444-4444-4444-444444444444")
                .expect("Invalid fixture UUID");
...
async fn test_audit_trail_integrity() {
    ...
    with_transaction(&db, |txn| {
        async move {
            let fixture_id = Uuid::parse_str("55555555-5555-5555-5555-555555555555")
                .expect("Invalid fixture UUID");
...
async fn test_dry_run_mode() {
    ...
    with_transaction(&db, |txn| {
        async move {
            ...
            let fixture_id = Uuid::parse_str("66666666-6666-6666-6666-666666666666")
                .expect("Invalid fixture UUID");
...
async fn test_audit_trail_prior_status() {
    ...
    with_transaction(&db, |txn| {
        async move {
            let fixture_id = Uuid::parse_str("77777777-7777-7777-7777-777777777777")
                .expect("Invalid fixture UUID");
...
async fn test_audit_trail_edit_snapshots() {
    ...
    with_transaction(&db, |txn| {
        async move {
            let fixture_id = Uuid::parse_str("88888888-8888-8888-8888-888888888888")
                .expect("Invalid fixture UUID");
...
async fn test_audit_trail_reject_snapshots() {
    ...
    with_transaction(&db, |txn| {
        async move {
            let fixture_id = Uuid::parse_str("99999999-9999-9999-9999-999999999999")
                .expect("Invalid fixture UUID");
...
async fn test_escalation_low_confidence() {
    ...
    with_transaction(&db, |txn| {
        async move {
            let fixture_id = Uuid::parse_str("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa")
                .expect("Invalid fixture UUID");
